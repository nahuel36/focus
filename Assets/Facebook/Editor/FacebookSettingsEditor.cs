...
namespace Facebook.Unity.Editor
{
    ...
    public class FacebookSettingsEditor : UnityEditor.Editor
    {
        ...
        private void FBParamsInitGUI()
        {
            ...
            {
                FacebookSettings.Cookie = EditorGUILayout.Toggle(cookieLabel, FacebookSettings.Cookie);
                FacebookSettings.Logging = EditorGUILayout.Toggle(loggingLabel, FacebookSettings.Logging);
                FacebookSettings.Status = EditorGUILayout.Toggle(statusLabel, FacebookSettings.Status);
                FacebookSettings.Xfbml = EditorGUILayout.Toggle(xfbmlLabel, FacebookSettings.Xfbml);
                FacebookSettings.FrictionlessRequests = EditorGUILayout.Toggle(frictionlessLabel, FacebookSettings.FrictionlessRequests);
            }
            EditorGUILayout.Space();
        }
        ...
        private void AboutGUI()
        {
            ...
            SelectableLabelField(sdkVersion, FacebookSdkVersion.Build);
            EditorGUILayout.Space();
        }
